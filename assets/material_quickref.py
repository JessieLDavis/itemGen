...
# tagOpts = [0                        1                       2                       3                       4                       5
#    0 ["protective equipment",   "medical equipment",    "combat equipment",     "textile equipment"],
#    1 ["entertainment device",   "communication device", "illumination device",  "transportation device","musical device"],
#    2 ["cultural item",          "stabbing item",        "scooping item",        "storage item",         "slashing item",        "decorative item"],
#    3 ["dining tool",            "cutting tool",         "maker tool",           "prediction tool",      "investigative tool"]]
# sizeOpts = {0:"any",1:"small",2:"medium",3:"large"}